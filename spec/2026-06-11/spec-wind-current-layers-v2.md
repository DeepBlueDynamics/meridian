# spec-wind-current-layers-v2.md

**Component:** Wind & current visualization layers (implemented)
**Spec-ID:** wind-current-layers
**Version:** v2
**Status:** active
**Revised:** 2026-06-11 (UTC)
**Depends-on:** spec-service-layer
**Referenced-by:** spec-chart-style
**Supersedes:** spec-wind-current-layers
**License-posture:** Apache-2.0. Data: ECMWF Open Data (CC-BY-4.0), GFS/NOMADS (public), MeteoFrance SMOC (open w/ attribution), Open-Meteo JSON for dev. Render: deck.gl (MIT) over MapLibre (BSD-3).

> v2 = v1 formalization + the shipped implementation: `lib/field.js` + `lib/fieldlayer.js` + `layers.html` (implementation notes at bottom).
